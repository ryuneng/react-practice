...
public class CartRepositoryTests {
    ...
    public void testInsertByProduct() {
        ...
        // 2. 장바구니 아이템이 없었다면 장바구니부터 확인
        // - 1) 사용자가 장바구니를 만든적이 있는지 확인
        Optional<Cart> result = cartRepository.getCartOfMember(email);

        Cart cart = null;

        // - 2) 사용자의 장바구니가 존재하지 않으면 장바구니 생성
        if (result.isEmpty()) {
    ...
    @Test
    public void testListOfMember() { // 사용자가 로그인을 했다면 장바구니 아이템 목록을 볼 수 있는 기능 테스트
