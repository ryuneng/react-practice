...
public class MemberServiceImpl implements MemberService {
    ...
    public MemberDTO getKakaoMember(String accessToken) {
        ...
        String nickname = getEmailFromKakaoAccessToken(accessToken); // email

        log.info("nickname: " + nickname); // email

        Optional<Member> result = memberRepository.findById(nickname); // email
        ...
        Member socialMember = makeSocialMember(nickname); // email
    ...
    private String getEmailFromKakaoAccessToken(String accessToken) {
        ...
        LinkedHashMap<String, String> properties = bodyMap.get("properties"); // kakaoAccount =
                                                                              // bodyMap.get("kakao_account");
